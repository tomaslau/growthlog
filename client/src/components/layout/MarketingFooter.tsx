...
export function MarketingFooter() {
  return (
    <footer className="border-t border-zinc-200/80 mt-24 dark:border-zinc-700/80">
      <div className="container mx-auto px-6 py-8 max-w-6xl">
        <div className="flex flex-col gap-8">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-5 pb-8 border-b border-zinc-200/80 dark:border-zinc-700/80">
            <div className="space-y-3">
              ...
              <p className="text-sm text-zinc-500 max-w-[280px] dark:text-zinc-400">
          ...
          <div className="flex items-center justify-between text-sm text-zinc-400 dark:text-zinc-500">
            ...
            <div className="flex items-center gap-2">
              Built by{" "}
              <a href="https://craftled.com" className="inline-flex items-center hover:text-zinc-800 dark:hover:text-zinc-200">
